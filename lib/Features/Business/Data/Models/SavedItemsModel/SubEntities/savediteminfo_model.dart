...
class SavedItemInfoModel extends SavedItemInfoEntity {
  const SavedItemInfoModel({
    super.id,
    super.createdBy,
    super.categoryId,
    super.subCategoryId,
  ...
  factory SavedItemInfoModel.fromJson(Map<String, dynamic> json) {
    return SavedItemInfoModel(
      id: json['id'],
